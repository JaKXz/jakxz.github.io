...
<button
  ...
  class="menu-button inline-grid h-10 w-10 cursor-pointer place-items-center border-none bg-[var(--sheet)] p-0 text-[var(--ink)] transition-colors hover:border-[var(--accent)] hover:text-[var(--accent)] sm:hidden"

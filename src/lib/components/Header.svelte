...
<header
	class="xs:w-4/5 xs:max-w-54rem xs:border-solid xs:mt-8 mx-auto mb-2 flex justify-between border-0.5 border-gray border-rounded-t bg-white px-8 py-6 text-[var(--darker)] shadow-lg dark:bg-[var(--dark)]"
>

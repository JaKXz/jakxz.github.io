...
<footer
  class={classNames(
    "site-footer rounded-1 relative z-1 mx-auto -mt-4 mb-6 border border-[var(--border)] bg-[var(--sheet-muted)] px-5 py-8 text-sm text-[var(--muted-ink)]",
    path === "/"
...
>
  <div class="grid gap-8 sm:grid-cols-[auto_1fr]">
    <div class="flex flex-col gap-4">
      <p class="font-600 m-0 p-0 text-xs tracking-[0.18em] uppercase">elsewhere</p>
      <ul class="m-0 flex list-none flex-wrap gap-2 p-0">
        ...
        <li class="m-0 p-0">
          <a class="social-link h-11" href="https://github.com/jakxz" aria-label="GitHub">

...
<button
  type="button"
  class="theme-toggle m-0 h-11 w-11 inline-grid cursor-pointer place-items-center border border-[var(--border)] rounded-full bg-[var(--sheet-muted)] p-0 text-[var(--ink)] hover:border-[var(--accent)] hover:bg-[var(--sheet)] focus-visible:border-[var(--accent)] focus-visible:bg-[var(--sheet)]"

import{a as i,t as k}from"./disclose-version.D_6FvSZB.js";import{s as t,f as r,i as o,r as p,n as d}from"./runtime.BDXICSVk.js";import{h as e}from"./html.BtMJjPRH.js";const g={title:"Write React components like an essay",date:"2023-02-09",updated:"2023-05-08",categories:["react","web","dev"]};var m=k(`<p>If you’re a developer who writes React components, you may have found yourself wondering how to structure your code to make it more readable and maintainable.
...
you would just need to determine what the “thesis” is and see if it makes sense to use “supporting arguments” as described here.</p>`,1);function w(c){var s=m(),n=t(r(s),6),l=o(n);e(l,()=>`<code class="language-tsx"><span class="token comment">// app/components/Profile.jsx</span>
...
<span class="token punctuation">&#125;</span></code>`),p(a),d(2),i(c,s)}export{w as default,g as metadata};

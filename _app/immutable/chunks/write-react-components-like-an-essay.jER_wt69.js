import{s as U,n as T}from"./scheduler.EloVU2S9.js";import{S as W,i as D,e as o,s as d,H,a as p,p as h,b as f,o as L,z as M,d as a,g as O,k as t}from"./index.3e0jgRul.js";function G(z){let e,S=`If you’re a developer who writes React components, you may have found yourself wondering how to structure your code to make it more readable and maintainable.
...
Then, put supporting “arguments” (helpers, subcomponents, etc.) immediately following in order of relevance and use.`,w,l,N="Let’s look at an example of a <code>Profile.jsx</code> component:",g,u,x,B=`<code class="language-tsx"><span class="token comment">// app/components/Profile.jsx</span>
...
<span class="token punctuation">&#125;</span></code>`,v,i,I=`In this example, the main export of the file, the Profile component, is buried under a lot of supporting code.
...
By reordering the code to put the main export first, you can make it easier for other developers (or your future self!) to quickly understand what the component is doing and find the relevant code.`,b,k,j="Here’s an example of what the same Profile.jsx file could look like if it followed the essay structure:",_,r,C,q=`<code class="language-tsx"><span class="token comment">// app/components/Profile.jsx</span>
<span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">'react'</span><span class="token punctuation">;</span>
...
you would just need to determine what the “thesis” is and see if it makes sense to use “supporting arguments” as described here.`;return{c(){e=o("p"),e.textContent=S,y=d(),c=o("p"),c.textContent=R,w=d(),l=o("p"),l.innerHTML=N,g=d(),u=o("pre"),x=new H(!1),v=d(),i=o("p"),i.textContent=I,b=d(),k=o("p"),k.textContent=j,_=d(),r=o("pre"),C=new H(!1),P=d(),m=o("p"),m.textContent=A,this.h()},l(n){e=p(n,"P",{"data-svelte-h":!0}),h(e)!=="svelte-8hsng9"&&(e.textContent=S),y=f(n),c=p(n,"P",{"data-svelte-h":!0}),h(c)!=="svelte-hzurib"&&(c.textContent=R),w=f(n),l=p(n,"P",{"data-svelte-h":!0}),h(l)!=="svelte-1enn30w"&&(l.innerHTML=N),g=f(n),u=p(n,"PRE",{class:!0});var s=L(u);x=M(s,!1),s.forEach(a),v=f(n),i=p(n,"P",{"data-svelte-h":!0}),h(i)!=="svelte-zhxkaz"&&(i.textContent=I),b=f(n),k=p(n,"P",{"data-svelte-h":!0}),h(k)!=="svelte-91skd"&&(k.textContent=j),_=f(n),r=p(n,"PRE",{class:!0});var E=L(r);C=M(E,!1),E.forEach(a),P=f(n),m=p(n,"P",{"data-svelte-h":!0}),h(m)!=="svelte-1fsg6g3"&&(m.textContent=A),this.h()},h(){x.a=null,O(u,"class","language-tsx"),C.a=null,O(r,"class","language-tsx")},m(n,s){t(n,e,s),t(n,y,s),t(n,c,s),t(n,w,s),t(n,l,s),t(n,g,s),t(n,u,s),x.m(B,u),t(n,v,s),t(n,i,s),t(n,b,s),t(n,k,s),t(n,_,s),t(n,r,s),C.m(q,r),t(n,P,s),t(n,m,s)},p:T,i:T,o:T,d(n){n&&(a(e),a(y),a(c),a(w),a(l),a(g),a(u),a(v),a(i),a(b),a(k),a(_),a(r),a(P),a(m))}}}const Y={title:"Write React components like an essay",date:"2023-02-09",updated:"2023-05-08",categories:["react","web","dev"]};class F extends W{constructor(e){super(),D(this,e,null,G,U,{})}}export{F as default,Y as metadata};

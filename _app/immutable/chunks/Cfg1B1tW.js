import{D as e,T as t,U as n,W as r,b as i,nt as a,rt as o}from"./BsbTQ-xr.js";import"./xihTtKlq.js";import"./ByiAq_SA.js";var s={title:`Write React components like an essay`,date:`2023-02-09`,updated:`2025-05-08`,categories:[`react`,`web`,`dev`]},{title:c,date:l,updated:u,categories:d}=s,f=e(`<p>If you’re a developer who writes React components, you may have found yourself wondering how to structure your code to make it more readable and maintainable.
...
you would just need to determine what the “thesis” is and see if it makes sense to use “supporting arguments” as described here.</p>`,1);function p(e){var s=f(),c=r(n(s),6);i(c,()=>`<code class="language-tsx"><span class="token comment">// app/components/Profile.tsx (types omitted for brevity)</span>
...
<span class="token punctuation">&#125;</span></code>`,!0),o(c);var l=r(c,6);i(l,()=>`<code class="language-tsx"><span class="token comment">// app/components/Profile.tsx (types omitted for brevity)</span>
<span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">'react'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`,!0),o(l),a(4),t(e,s)}export{p as default,s as metadata};
import"./NZTpNUN0.js";import"./ZQLZ0rgz.js";import{C as i,J as t,F as k,G as r,W as o,X as p,Z as d}from"./j8U-BjCg.js";import{h as e}from"./BL8JFeFi.js";const m={title:"Write React components like an essay",date:"2023-02-09",updated:"2023-05-08",categories:["react","web","dev"]},{title:b,date:v,updated:x,categories:_}=m;var h=i(`<p>If you’re a developer who writes React components, you may have found yourself wondering how to structure your code to make it more readable and maintainable.
...
you would just need to determine what the “thesis” is and see if it makes sense to use “supporting arguments” as described here.</p>`,1);function P(c){var s=h(),n=t(k(s),6),l=o(n);e(l,()=>`<code class="language-tsx"><span class="token comment">// app/components/Profile.jsx</span>
...
<span class="token punctuation">&#125;</span></code>`),p(a),d(2),r(c,s)}export{P as default,m as metadata};

import{b as i,t as k}from"./disclose-version.C5ZaUgfg.js";import"./legacy.B3dUIBph.js";import{h as t,c as r,r as o,t as p,w as d}from"./runtime.I8AkAxFz.js";import{h as e}from"./html.CCqmz66C.js";const w={title:"Write React components like an essay",date:"2023-02-09",updated:"2023-05-08",categories:["react","web","dev"]};var m=k(`<p>If you’re a developer who writes React components, you may have found yourself wondering how to structure your code to make it more readable and maintainable.
...
you would just need to determine what the “thesis” is and see if it makes sense to use “supporting arguments” as described here.</p>`,1);function b(c){var s=m(),n=t(r(s),6),l=o(n);e(l,()=>`<code class="language-tsx"><span class="token comment">// app/components/Profile.jsx</span>
...
<span class="token punctuation">&#125;</span></code>`),p(a),d(2),i(c,s)}export{b as default,w as metadata};
